...
import com.mdy.basis.cache.ehcache.EhCacheProvider;
...
public class CacheManager {
	...
	public static void initCacheProvider(CacheExpiredListener listener){
		...
		try{
			...
			Properties props = BasisCache.getConfig();
	 ...
	 * @param value Cache value
	 */
	public final static void set(int level, String name, Object key, Object value,int expireTime){
		//System.out.println("SET => " + name+":"+key+"="+value);
		if(name!=null && key != null && value!=null) {
