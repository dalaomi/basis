 ...
 */
package com.mdy.basis.cache.ehcache;

import java.util.List;

import com.mdy.basis.cache.Cache;
import com.mdy.basis.cache.CacheException;
import com.mdy.basis.cache.CacheExpiredListener;
import com.mdy.basis.cache.CacheManager;
...
public class EhCache implements Cache, CacheEventListener {
	...
	public EhCache(net.sf.ehcache.Cache cache, CacheExpiredListener listener) {
		...
		//this.defaultExpireTime = Integer.valueOf(BasisCache.getConfig().getProperty("redis.default.expire_time","3600"));
		this.defaultExpireTime = 3600;//默认都是1小时
	}
